            ...
            <div class="row">
                <div class="col-lg-8">
                    <div class="blog-item style-three" data-aos="fade-up" data-aos-duration="1500" data-aos-offset="50">
                        <div class="image">
                            <img src="{{ asset('client/images/blog/blog-list1.jpg') }}" alt="Blog List">
                        </div>
                        <div class="content">
                            ...
                            <a href="{{ route('blog.detail') }}" class="theme-btn style-two style-three">
                    ...
                    <div class="blog-item style-three" data-aos="fade-up" data-aos-duration="1500" data-aos-offset="50">
                        <div class="image">
                            <img src="{{ asset('client/images/blog/blog-list2.jpg') }}" alt="Blog List">
                        </div>
                        <div class="content">
                            <a href="blog.html" class="category">Travel</a>
                            <h5><a href="blog-details.html">Ultimate Guide to Planning Your Dream Vacation</a></h5>
                    ...
                    <div class="blog-item style-three" data-aos="fade-up" data-aos-duration="1500" data-aos-offset="50">
                        <div class="image">
                            <img src="{{ asset('client/images/blog/blog-list3.jpg') }}" alt="Blog List">
                        </div>
                        <div class="content">
                            <a href="blog.html" class="category">Travel</a>
                            <h5><a href="blog-details.html">Ultimate Guide to Planning Your Dream Vacation</a></h5>
                    ...
                    <div class="blog-item style-three" data-aos="fade-up" data-aos-duration="1500" data-aos-offset="50">
                        <div class="image">
                            <img src="{{ asset('client/images/blog/blog-list4.jpg') }}" alt="Blog List">
                        </div>
                        <div class="content">
                            <a href="blog.html" class="category">Travel</a>
                            <h5><a href="blog-details.html">Ultimate Guide to Planning Your Dream Vacation</a></h5>
                    ...
                    <div class="blog-item style-three" data-aos="fade-up" data-aos-duration="1500" data-aos-offset="50">
                        <div class="image">
                            <img src="{{ asset('client/images/blog/blog-list5.jpg') }}" alt="Blog List">
                        </div>
                        <div class="content">
                            <a href="blog.html" class="category">Travel</a>
                            <h5><a href="blog-details.html">Ultimate Guide to Planning Your Dream Vacation</a></h5>
                ...
                <div class="col-lg-4 col-md-8 col-sm-10 rmt-75">
                    <div class="blog-sidebar">
                        ...
                        <div class="widget widget-cta" data-aos="fade-up" data-aos-duration="1500" data-aos-offset="50">
                            ...
                            <div class="cta-shape"><img src="{{ asset('client/images/widgets/cta-shape.png') }}" alt="Shape"></div>
                        </div>
