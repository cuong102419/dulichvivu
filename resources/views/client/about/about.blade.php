...
@section('banner')
    @include('client.layout.partials.banner', ['title' => 'Giới thiệu chúng tôi'])
@endsection
        ...
        <div class="container">
            <div class="row justify-content-between">
                <div class="col-xl-3" data-aos="fade-right" data-aos-duration="1500" data-aos-offset="50">
                    <span class="subtitle mb-35">Về chúng tôi</span></span>
                </div>
                <div class="col-xl-9">
                        ...
                        <div class="row">
                            <div class="col-lg-8 pe-lg-5 me-lg-5">
                                <div class="section-title mb-25">
                                    <h2>Kinh nghiệm & công ty lữ hành chuyên nghiệp tại Việt Nam</h2>
                                </div>
                            </div>
                            <div class="col-md-4">
                            ...
                            <div class="col-md-8">
                                <p>Chúng tôi chuyên xây dựng những trải nghiệm thành phố khó quên cho du khách tìm kiếm khám
                                    phá trái tim và linh hồn của cảnh quan đô thị. Các tour du lịch có hướng dẫn chuyên
                                    nghiệp của chúng tôi thực hiện hành trình qua những con đường sôi động, các địa danh
                                    lịch sử và đá quý ẩn giấu của mỗi thành phố.</p>
            ...
            <div class="row align-items-center">
                <div class="col-xl-4 col-md-6">
                    <div class="about-feature-image" data-aos="fade-up" data-aos-duration="1500" data-aos-offset="50">
                        <img src="{{ asset('client/images/about/about-feature1.jpg') }}" alt="About">
                    </div>
                </div>
                <div class="col-xl-4 col-md-6">
                    <div class="about-feature-image" data-aos="fade-up" data-aos-delay="50" data-aos-duration="1500"
                        data-aos-offset="50">
                        <img src="{{ asset('client/images/about/about-feature2.jpg') }}" alt="About">
                    </div>
                </div>
                    ...
                    <div class="about-feature-boxes" data-aos="fade-up" data-aos-delay="100" data-aos-duration="1500"
                        ...
                        <div class="feature-item style-three bgc-secondary">
                            <div class="icon-title">
                                ...
                                <h5><a href="destination-details.html">Chúng tôi là công ty từng đoạt giải thưởng</a></h5>
                            </div>
                            <div class="content">
                        ...
                        <div class="feature-item style-three bgc-primary">
                            ...
                            <div class="content">
                                <p>Đội ngũ chuyên gia của chúng tôi đang tận tâm phát triển các chiến lược tiên tiến thúc
                                    đẩy thành công
                                </p>
                            </div>
                        </div>
            ...
            <div class="row align-items-center">
                <div class="col-xl-5 col-lg-6">
                    <div class="about-us-content rmb-55" data-aos="fade-left" data-aos-duration="1500" data-aos-offset="50">
                        <div class="section-title mb-25">
                            <h2>Du lịch tự tin. Những lý do hàng đầu để chọn đại lý của chúng tôi</h2>
                        </div>
                        <p>Chúng tôi hợp tác chặt chẽ với khách hàng để hiểu những thách thức và mục tiêu, cung cấp các giải
                            pháp tùy chỉnh để nâng cao hiệu quả, tăng lợi nhuận và thúc đẩy tăng trưởng bền vững.</p>
                        <div class="row pt-25">
                            <div class="col-6">
                ...
                <div class="col-xl-7 col-lg-6" data-aos="fade-right" data-aos-duration="1500" data-aos-offset="50">
                    <div class="about-us-page">
                        <img src="{{ asset('client/images/about/about-page.jpg') }}" alt="About">
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="about-feature-two bgc-black pt-100 pb-45 rel z-1">
        <div class="container">
            <div class="section-title text-center text-white counter-text-wrap mb-50" data-aos="fade-up"
                data-aos-duration="1500" data-aos-offset="50">
                <h2>Làm thế nào để mang lại lợi ích cho các chuyến tham quan và du lịch Ravelo của chúng tôi</h2>
            </div>
            <div class="row">
                ...
                <div class="col-xl-3 col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="100" data-aos-duration="1500"
                    ...
                    <div class="feature-item style-two">
                        ...
                        <div class="content">
                            <h5><a href="destination-details.html">Booking nhanh chóng</a></h5>
        ...
        <div class="shape">
            <img src="{{ asset('client/images/video/shape1.png') }}" alt="shape">
        </div>
    </section>
    <!-- Features Area end -->
