...
<link href="{{  asset('administrator/vendors/bootstrap-progressbar/css/bootstrap-progressbar-3.3.4.min.css') }}"
    rel="stylesheet">
<!-- JQVMap -->
<link href="{{  asset('administrator/vendors/jqvmap/dist/jqvmap.min.css') }}" rel="stylesheet"/>
<!-- bootstrap-daterangepicker -->
<link href="{{  asset('administrator/vendors/bootstrap-daterangepicker/daterangepicker.css') }}" rel="stylesheet">
